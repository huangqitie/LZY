				...
				<table width="100%" border="0" cellpadding="0" cellspacing="10"
					...
					<tr>
						<td class="font3 fftd">公告标题：<input type="text" name="title"
							size="30" id="title" value="参加会议通知" /> <span
					...
					<tr>
						<td class="font3 fftd">公告内容：<br /> <textarea name="content"
								cols="88" rows="11" id="content">今天有技术部有会议</textarea>
						</td>
					</tr>
					<tr>
						<td class="main_tdbor"></td>
					...
					<tr>
						<td class="font3 fftd"><input type="button"
							onclick="submit()" value="修改"> <input type="reset"
							value="重置"></td>
					</tr>
					<tr>
						<td class="main_tdbor"></td>

				...
				<td>
					...
					<table width="100%" height="90%" border="0" cellpadding="5"
						...
						<tbody>
							<tr valign="top">
								<td>
									<!-- 隐藏表单，flag表示添加标记 --> <input type="hidden" name="flag"
										...
										<tbody>
														...
														<tbody>
															...
															<tr>
																<td class="font3 fftd">学历：<input name="education"
																	id="education" size="20" value="本科"></td>
															...
															<tr>
																<td class="font3 fftd">手机：<input name="phone"
																	id="phone" size="20" value="13902001111"></td>
																<td class="font3 fftd">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：<input
																	name="tel" id="tel" size="20" value="020-77777777"></td>
															</tr>
											...
											<tr>
												<td class="font3 fftd">所学专业：<input name="speciality"
													id="speciality" size="40" value="美声">&nbsp;&nbsp;
											...
											<tr>
												<td class="font3 fftd">备&nbsp;&nbsp;&nbsp;&nbsp;注：<input
													name="remark" id="remark" size="40" value="四大天王">
													&nbsp;&nbsp;所属部门： <select name="dept_id"
													style="width: 100px;">

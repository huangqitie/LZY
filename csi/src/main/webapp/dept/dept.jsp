					...
					<tbody>
						...
						<tr id="data_0" align="center" class="main_trbg"
							...
							<td align="center" width="40px;"><a
								href="showUpdateDept.html"> <img title="修改"
									src="../images/update.gif"></a></td>

						</tr>

						<tr id="data_1" align="center" class="main_trbg"
							style="background-color: rgb(238, 204, 255);">
					...
					<tbody>
						<tr>
							<td
								...
								class="disabled">上一页</span><span class="current">1</span><a
								href="#">2</a><a href="#">下一页</a>&nbsp;跳转到&nbsp;&nbsp;<input
						...
						<tr>
							<td
								...
								color="red">6</font>条记录，当前显示1-4条记录。
							</td>
						</tr>
					</tbody>
				</table>

	...
	<div class="login-box" id="loginbox">
		...
		<div class="login" id="main_login">
			...
			<div class="input_text">
				...
				<form
					action="${pageContext.request.contextPath }/userServlet?cmd=login"
					...
					<div class="content">
						...
						<div class="formitem">
							<span class="icon fa fa-user"></span> <span class="input">
								<input id="loginname" name="loginname" class="form-control l35"
								fv_type="NOTCN" type="text" maxlength="20"
								placeholder="请输入您的用户名" data-toggle="tooltip"
								data-placement="right">
							</span>
						</div>
						<div class="formitem">
							<span class="icon fa fa-key"></span> <span class="input">
						...
						<div class="formoperate">
							<span class="rememberPwd"> <input type="checkbox"
								id="rememberPwd" /><label for="rememberPwd">记住密码</label>
							</span> <select id="status" name="status" class="input"
								style="margin-top: 6px; margin-left: 50px; height: 24px; border-radius: 5px">
								<option value="">请选择用户类型...</option>
								<option value="1" ${'1'==user.status?'selected':'' }>超级管理员</option>
								<option value="2" ${'2'==user.status?'selected':'' }>管理员</option>
								<option value="3" ${'3'==user.status?'selected':'' }>员工</option>
							</select>
						</div>
						<div>
							...
							<button type="button" title="刷脸登录" data-search-open=""
								data-title="刷脸登录" modal-toggle="modal" data-href="face/face.jsp"
								data-width="780" data-height="500" class="layui-btn  btn-login"
								style="width: 150px">&nbsp;&nbsp;刷 脸&nbsp;&nbsp;</button>
						</div>

						<div class="formoperate" id="tishi"
							style="text-align: center; color: red; padding-top: 15px"></div>
					</div>
				</form>
